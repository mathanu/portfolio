...
const HomeCmp = () => {
  return (
    <div className="md:h-[75%] h-[75%] absolute mt-20 w-full bg-yellow-400 flex border-b border-black">
      ...
      <div className="w-6/12 md:visible md:relative invisible absolute">
